<template>
  <div>
    ...
    Chord Name: <input type="text" v-model="name" /> Tuning:
    <input type="text" v-model="tuning" /> Output: {{ jsonOutput }}
  </div>
</template>
...
import ChordDiagram from "../chordDiagram/elements/BaseChord.vue";
import BaseFretboard from "./BaseFretboard.vue";
import BaseFingering from "./BaseFingering.vue";
